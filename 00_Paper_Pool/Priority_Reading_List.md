...
3. [[02_Papers/05_Sim2Real/Sim2Real-VLA|Sim2Real-VLA]] — 合成数据到真机、双臂与长时序；特别关注。
...
3. [[02_Papers/01_VLA/ReconVLA|ReconVLA]] — 以凝视区域重建提升 VLA 的视觉 Grounding、精确操作和泛化；特别关注。
...
7. [[02_Papers/01_VLA/VLA-Cache|VLA-Cache]] — 无需重训的跨帧 token 缓存；适合测量本地 VLA 实时推理收益，。
