...
- Subcategory: Mobile Manipulation
...
- Subcategories: Mobile Manipulation
- Tags: Mobile Manipulation

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/CVPR2025/html/Wu_MoManipVLA_Transferring_Vision-language-action_Models_for_General_Mobile_Manipulation_CVPR_2025_paper.html
- DOI: Unknown
- arXiv: Unknown
...
- Embodiment: Mobile Manipulator / Single Arm
...
- **Key Idea:** 以 `Mobile Manipulation` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Citation Source Identifier: https://openalex.org/W4413147465
