...
- Authors: Uppal, Shagun; Agarwal, Ananye; Xiong, Haoyu; Shaw, Kenneth; Pathak, Deepak
- Year: 2024
- Venue: CVPR
- CCF Level: A
...
- Subcategory: Mobile Manipulation / Navigation
- Keywords: Unknown
...
- Subcategories: Mobile Manipulation / Navigation
- Tags: Unknown
...
- **Problem:** 研究主题为 `Mobile Manipulation / Navigation`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- Sources: https://openaccess.thecvf.com/content/CVPR2024/html/Uppal_SPIN_Simultaneous_Perception_Interaction_and_Navigation_CVPR_2024_paper.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4402772268
- OpenAlex Work: https://openalex.org/W4402772268

## Standardized Research Fields

### Research Problem
研究主题为 `Mobile Manipulation / Navigation`；本卡仅按官方摘要级证据整理，未替代全文审阅。
...
### Evidence Sources
https://openaccess.thecvf.com/content/CVPR2024/html/Uppal_SPIN_Simultaneous_Perception_Interaction_and_Navigation_CVPR_2024_paper.html; https://spin-robot.github.io
