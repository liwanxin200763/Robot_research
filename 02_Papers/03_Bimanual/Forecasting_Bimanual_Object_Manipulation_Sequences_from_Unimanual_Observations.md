...
- Subcategory: Motion Forecasting / Hand-Object Contact
- Keywords: Unknown
...
- Subcategories: Motion Forecasting / Hand-Object Contact
- Tags: Unknown

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/28266
...
- Embodiment: Bimanual Human Motion
...
- **Problem:** 研究主题为 `Motion Forecasting / Hand-Object Contact`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/28266；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4393158202
- OpenAlex Work: https://openalex.org/W4393158202

## Standardized Research Fields

### Research Problem
研究主题为 `Motion Forecasting / Hand-Object Contact`；本卡仅按官方摘要级证据整理，未替代全文审阅。
