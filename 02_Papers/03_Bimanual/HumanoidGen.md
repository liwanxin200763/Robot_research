...
- Authors: Jing, Zhi; Yang, Siyuan; Ao, Jicong; Xiao, Ting; Jiang, Yu-Gang; Bai, Chenjia
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Humanoid / Synthetic Demonstrations / LLM Planning
- Keywords: Unknown

## Classification

- Primary Category: Bimanual
- Categories: Robot Manipulation; Bimanual; Dexterous; Data / Teleoperation; Benchmark / Dataset
- Subcategories: Humanoid / Synthetic Demonstrations / LLM Planning
- Tags: Unknown

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/e4ef7454447baa15a424314e6284441b-Abstract-Conference.html
...
- Embodiment: Humanoid / Bimanual / Dexterous Hand
...
- **Problem:** 研究主题为 `Humanoid / Synthetic Demonstrations / LLM Planning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - For robotic manipulation, existing robotics datasets and simulation benchmarks predominantly cater to robot-arm platforms.
  - In experiments, we create a novel benchmark with augmented scenarios to evaluate the quality of the collected data.
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/e4ef7454447baa15a424314e6284441b-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4417041439
- OpenAlex Work: https://openalex.org/W4417041439

## Standardized Research Fields

### Research Problem
研究主题为 `Humanoid / Synthetic Demonstrations / LLM Planning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/e4ef7454447baa15a424314e6284441b-Abstract-Conference.html; https://openhumanoidgen.github.io
