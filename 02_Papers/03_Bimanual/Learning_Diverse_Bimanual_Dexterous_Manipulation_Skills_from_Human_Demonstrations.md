...
- Subcategory: Human Demonstrations / Reinforcement Learning
- Keywords: Unknown

## Classification

- Primary Category: Bimanual
- Categories: Robot Manipulation; Bimanual; Dexterous; Diffusion / Flow / IL / RL; Data / Teleoperation
- Subcategories: Human Demonstrations / Reinforcement Learning
- Tags: Unknown

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/40127
...
- **Problem:** 研究主题为 `Human Demonstrations / Reinforcement Learning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/40127；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W7138037195
- OpenAlex Work: https://openalex.org/W7138037195

## Standardized Research Fields

### Research Problem
研究主题为 `Human Demonstrations / Reinforcement Learning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
...
### Evidence Sources
https://ojs.aaai.org/index.php/AAAI/article/view/40127
