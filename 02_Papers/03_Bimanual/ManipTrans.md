...
- Subcategory: Residual Learning / Sim-to-Real
- Keywords: Residual Learning / Sim-to-Real

## Classification

- Primary Category: Bimanual
- Categories: Robot Manipulation; Bimanual; Dexterous; Sim2Real
- Subcategories: Residual Learning / Sim-to-Real
- Tags: Residual Learning / Sim-to-Real

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/CVPR2025/html/Li_ManipTrans_Efficient_Dexterous_Bimanual_Manipulation_Transfer_via_Residual_Learning_CVPR_2025_paper.html
- DOI: Unknown
- arXiv: Unknown
...
- **Problem:** 研究主题为 `Residual Learning / Sim-to-Real`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - To address this, we introduce ManipTrans, a novel two-stage method for efficiently transferring human bimanual skills to dexterous robotic hands in simulation.
  - Experiments show that ManipTrans surpasses state-of-the-art methods in success rate, fidelity, and efficiency.
- **Key Idea:** 以 `Residual Learning / Sim-to-Real` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://openaccess.thecvf.com/content/CVPR2025/html/Li_ManipTrans_Efficient_Dexterous_Bimanual_Manipulation_Transfer_via_Residual_Learning_CVPR_2025_paper.html；官方摘要/论文集元数据
...
### Research Problem
研究主题为 `Residual Learning / Sim-to-Real`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Residual Learning / Sim-to-Real` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://openaccess.thecvf.com/content/CVPR2025/html/Li_ManipTrans_Efficient_Dexterous_Bimanual_Manipulation_Transfer_via_Residual_Learning_CVPR_2025_paper.html; https://maniptrans.github.io/; https://github.com/ManipTrans/ManipTrans
