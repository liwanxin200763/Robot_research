...
- Authors: Jiang, Jian-Jian; Wu, Xiao-Ming; He, Yi-Xiang; Zeng, Ling-An; Wei, Yi-Lin; Zhang, Dandan; Zheng, Wei-Shi
- Year: 2025
- Venue: ICCV
- CCF Level: A
...
- Subcategory: Robot Manipulation / IL / Diffusion; Bimanual
- Keywords: bimanual manipulation; decoupled interaction; RoboTwin

## Classification

- Primary Category: Bimanual
- Categories: Robot Manipulation; Bimanual; Diffusion / Flow / IL / RL
- Subcategories: Robot Manipulation / IL / Diffusion; Bimanual
- Tags: bimanual manipulation; decoupled interaction; RoboTwin

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/ICCV2025/html/Jiang_Rethinking_Bimanual_Robotic_Manipulation_Learning_with_Decoupled_Interaction_Framework_ICCV_2025_paper.html
- DOI: Unknown
- arXiv: 
- Project Page: 
...
- **Main Contribution:**
  - In this paper, we propose a novel decoupled interaction framework that considers the characteristics of different tasks in bimanual manipulation.
...
- **Key Idea:** 以 `bimanual manipulation; decoupled interaction; RoboTwin` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://openaccess.thecvf.com/content/ICCV2025/html/Jiang_Rethinking_Bimanual_Robotic_Manipulation_Learning_with_Decoupled_Interaction_Framework_ICCV_2025_paper.html；官方摘要/论文集元数据
...
Evaluated on seven RoboTwin tasks; real robot status not stated in abstract.
...
- Citation Source Identifier: https://openalex.org/W4415101881
- OpenAlex Work: https://openalex.org/W4415101881
...
### Model / Method
以 `bimanual manipulation; decoupled interaction; RoboTwin` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
