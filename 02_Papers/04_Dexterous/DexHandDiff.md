...
- Subcategory: Diffusion / Contact-rich Manipulation
- Keywords: Diffusion / Contact-rich Manipulation

## Classification

- Primary Category: Dexterous
- Categories: Robot Manipulation; Dexterous; Diffusion / Flow / IL / RL
- Subcategories: Diffusion / Contact-rich Manipulation
- Tags: Diffusion / Contact-rich Manipulation

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/CVPR2025/html/Liang_DexHandDiff_Interaction-aware_Diffusion_Planning_for_Adaptive_Dexterous_Manipulation_CVPR_2025_paper.html
- DOI: Unknown
- arXiv: Unknown
...
- **Problem:** 研究主题为 `Diffusion / Contact-rich Manipulation`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - In this work, we introduce DexHandDiff, an interaction-aware diffusion planning framework for adaptive dexterous manipulation.
  - Experiments on physical interaction tasks such as door opening, pen and block re-orientation, object relocation, and hammer striking demonstrate DexHandDiff's effectiveness on goals outside training distributions, achieving over twice the average success rate (59.2% vs.
- **Key Idea:** 以 `Diffusion / Contact-rich Manipulation` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://openaccess.thecvf.com/content/CVPR2025/html/Liang_DexHandDiff_Interaction-aware_Diffusion_Planning_for_Adaptive_Dexterous_Manipulation_CVPR_2025_paper.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4413146641
- OpenAlex Work: https://openalex.org/W4413146641

## Standardized Research Fields

### Research Problem
研究主题为 `Diffusion / Contact-rich Manipulation`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Diffusion / Contact-rich Manipulation` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://openaccess.thecvf.com/content/CVPR2025/html/Liang_DexHandDiff_Interaction-aware_Diffusion_Planning_for_Adaptive_Dexterous_Manipulation_CVPR_2025_paper.html; https://dexdiffuser.github.io/; https://github.com/Liang-ZX/DexHandDiff
...
- [[02_Papers/09_Survey_Review/Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey|Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey]] — [arXiv full-text bibliography item 251](https://arxiv.org/html/2510.10903#bib.bib251)
