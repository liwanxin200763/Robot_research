...
- Authors: Xu, Guo-Hao; Wei, Yi-Lin; Zheng, Dian; Wu, Xiao-Ming; Zheng, Wei-Shi
- Year: 2024
- Venue: CVPR
- CCF Level: A
...
- Subcategory: Dexterous Grasping
...
- Subcategories: Dexterous Grasping
- Tags: Dexterous Grasping

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/CVPR2024/html/Xu_Dexterous_Grasp_Transformer_CVPR_2024_paper.html
- DOI: Unknown
- arXiv: Unknown
...
- **Key Idea:** 以 `Dexterous Grasping` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Citation Source Identifier: https://openalex.org/W4402816741
...
### Evidence Sources
https://openaccess.thecvf.com/content/CVPR2024/html/Xu_Dexterous_Grasp_Transformer_CVPR_2024_paper.html; https://github.com/iSEE-Laboratory/DGTR
...
- [[02_Papers/09_Survey_Review/Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey|Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey]] — [arXiv full-text bibliography item 238](https://arxiv.org/html/2510.10903#bib.bib238)
