...
- Subcategory: Human Video / Motion Retargeting
- Keywords: Unknown
...
- Subcategories: Human Video / Motion Retargeting
- Tags: Unknown

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/38874
...
- **Problem:** 研究主题为 `Human Video / Motion Retargeting`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/38874；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W7138113519
- OpenAlex Work: https://openalex.org/W7138113519

## Standardized Research Fields

### Research Problem
研究主题为 `Human Video / Motion Retargeting`；本卡仅按官方摘要级证据整理，未替代全文审阅。
