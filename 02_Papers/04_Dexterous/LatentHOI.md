...
- Authors: Li, Muchen; Christen, Sammy; Wan, Chengde; Cai, Yujun; Liao, Renjie; Sigal, Leonid; Ma, Shugao
- Year: 2025
- Venue: CVPR
- CCF Level: A
...
- Subcategory: Hand-Object Motion / Generalization
- Keywords: Unknown

## Classification

- Primary Category: Dexterous
- Categories: Robot Manipulation; Bimanual; Dexterous; Diffusion / Flow / IL / RL; Generalization / Long-Horizon
- Subcategories: Hand-Object Motion / Generalization
- Tags: Unknown

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/CVPR2025/html/Li_LatentHOI_On_the_Generalizable_Hand_Object_Motion_Generation_with_Latent_CVPR_2025_paper.html
- DOI: Unknown
- arXiv: Unknown
...
- Embodiment: Single and Bimanual Human Hand Model
...
- Sources: https://openaccess.thecvf.com/content/CVPR2025/html/Li_LatentHOI_On_the_Generalizable_Hand_Object_Motion_Generation_with_Latent_CVPR_2025_paper.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4413146191
- OpenAlex Work: https://openalex.org/W4413146191

## Standardized Research Fields

### Research Problem
研究主题为 `Hand-Object Motion / Generalization`；本卡仅按官方摘要级证据整理，未替代全文审阅。
