...
- Keywords: Dexterous Manipulation; Human Demonstrations / Motion Prior

## Classification

- Primary Category: Dexterous
- Categories: Robot Manipulation; Dexterous; Data / Teleoperation
- Subcategories: Dexterous Hand / Dexterous Manipulation
- Tags: Dexterous Manipulation; Human Demonstrations / Motion Prior

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/download/38892/42854
- DOI: Unknown
- arXiv: 
- Project Page: 
...
- **Main Contribution:**
  ...
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- **Key Idea:** 以 `Dexterous Manipulation; Human Demonstrations / Motion Prior` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/download/38892/42854；官方摘要/论文集元数据
...
### Model / Method
以 `Dexterous Manipulation; Human Demonstrations / Motion Prior` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://ojs.aaai.org/index.php/AAAI/article/download/38892/42854
...
- Problem: Dexterous manipulation across diverse objects is hard because hand dynamics and task-specific rewards do not transfer easily.
...
- Summary Evidence: Official abstract / paper page; https://ojs.aaai.org/index.php/AAAI/article/view/38892; checked 2026-09-23. Rapid summary only; existing Evidence Quality is unchanged.
