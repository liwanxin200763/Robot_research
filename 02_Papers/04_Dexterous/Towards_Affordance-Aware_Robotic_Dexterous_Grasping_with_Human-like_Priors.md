...
- Subcategory: Affordance / Policy Distillation
- Keywords: Unknown

## Classification

- Primary Category: Dexterous
- Categories: Robot Manipulation; Dexterous; Generalization / Long-Horizon
- Subcategories: Affordance / Policy Distillation
- Tags: Unknown

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/38313
...
- **Problem:** 研究主题为 `Affordance / Policy Distillation`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/38313；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W7138302344
- OpenAlex Work: https://openalex.org/W7138302344

## Standardized Research Fields

### Research Problem
研究主题为 `Affordance / Policy Distillation`；本卡仅按官方摘要级证据整理，未替代全文审阅。
...
### Evidence Sources
https://ojs.aaai.org/index.php/AAAI/article/view/38313
