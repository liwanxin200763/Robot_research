...
- Authors: Cheng, Shuo; Ma, Liqian; Chen, Zhenyang; Mandlekar, Ajay; Garrett, Caelan; Xu, Danfei
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Sim-to-Real / Behavior Cloning
- Keywords: Sim-to-Real / Behavior Cloning

## Classification

- Primary Category: Sim2Real
- Categories: Robot Manipulation; Sim2Real; Diffusion / Flow / IL / RL; Generalization / Long-Horizon
- Subcategories: Sim-to-Real / Behavior Cloning
- Tags: Sim-to-Real / Behavior Cloning

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/1185c89347a3f21ffc48c9d083c9437c-Abstract-Conference.html
...
- **Problem:** 研究主题为 `Sim-to-Real / Behavior Cloning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - In this work, we propose a unified sim-and-real co-training framework for learning generalizable manipulation policies that primarily leverages simulation and only requires a few real-world demonstrations.
  - Behavior cloning has shown promise for robot manipulation, but real-world demonstrations are costly to acquire at scale.
- **Key Idea:** 以 `Sim-to-Real / Behavior Cloning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/1185c89347a3f21ffc48c9d083c9437c-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4415251366
- OpenAlex Work: https://openalex.org/W4415251366

## Standardized Research Fields

### Research Problem
研究主题为 `Sim-to-Real / Behavior Cloning`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Sim-to-Real / Behavior Cloning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/1185c89347a3f21ffc48c9d083c9437c-Abstract-Conference.html
...
- [[02_Papers/09_Survey_Review/Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey|Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey]] — [arXiv full-text bibliography item 1209](https://arxiv.org/html/2510.10903#bib.bib1209)
