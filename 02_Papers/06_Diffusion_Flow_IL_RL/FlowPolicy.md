...
- Keywords: Robot Manipulation; Consistency Flow Matching / 3D Policy
...
- Tags: Robot Manipulation; Consistency Flow Matching / 3D Policy
...
- ModelScope: Unknown
- Checkpoint / Weights: 本轮未发现明确完整预训练策略权重入口；可按作者说明训练（作者入口/说明；未验证权重文件可下载或可用性）
...
- **Main Contribution:**
  ...
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- **Key Idea:** 以 `Robot Manipulation; Consistency Flow Matching / 3D Policy` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/33617；官方摘要/论文集元数据
...
AAAI Technical Track on Intelligent Robots，14754–14762。已查FlowPolicy类、训练与评估；README说明基准统计应取训练时记录，而独立eval脚本用于部署/推理。 Static checks only; no cloning/running or download.
...
- Problem: Iterative action generation can be too slow for responsive manipulation.
- Previous Gap: Not established in checked summary source.
- Core Idea: 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- Input: Not specified in checked abstract/card.
- Output / Action: Not specified in checked abstract/card.
- Dataset / Benchmark: 提供Adroit/MetaWorld示范生成脚本与说明；未下载数据
- Main Result: Adroit and MetaWorld evaluations report competitive manipulation performance with sevenfold faster inference.
...
- Summary Evidence: Official abstract / paper page; https://ojs.aaai.org/index.php/AAAI/article/view/33617; checked 2026-09-23. Rapid summary only; existing Evidence Quality is unchanged.
