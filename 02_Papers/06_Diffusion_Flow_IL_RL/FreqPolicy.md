...
- Authors: Su, Yifei; Liu, Ning; Chen, Dong; Zhao, Zhen; Wu, Kun; Li, Meng; Xu, Zhiyuan; Che, Zhengping; Tang, Jian
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Flow Matching / Visuomotor Policy
- Keywords: Flow Matching / Visuomotor Policy

## Classification

- Primary Category: Diffusion / Flow / IL / RL
- Categories: Robot Manipulation; Diffusion / Flow / IL / RL
- Subcategories: Flow Matching / Visuomotor Policy
- Tags: Flow Matching / Visuomotor Policy

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/282c3318be1b047b7bb5ba94fa4f3231-Abstract-Conference.html
...
- **Problem:** 研究主题为 `Flow Matching / Visuomotor Policy`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- **Key Idea:** 以 `Flow Matching / Visuomotor Policy` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/282c3318be1b047b7bb5ba94fa4f3231-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4417258107
- OpenAlex Work: https://openalex.org/W4417258107

## Standardized Research Fields

### Research Problem
研究主题为 `Flow Matching / Visuomotor Policy`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Flow Matching / Visuomotor Policy` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/282c3318be1b047b7bb5ba94fa4f3231-Abstract-Conference.html
...
- [[02_Papers/09_Survey_Review/Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey|Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey]] — [arXiv full-text bibliography item 873](https://arxiv.org/html/2510.10903#bib.bib873)
