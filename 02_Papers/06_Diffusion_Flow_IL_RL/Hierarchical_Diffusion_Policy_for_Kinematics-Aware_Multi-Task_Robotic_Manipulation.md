...
- Authors: Ma, Xiao; Patidar, Sumit; Haughton, Iain; James, Stephen
- Year: 2024
- Venue: CVPR
- CCF Level: A
...
- Keywords: Robot Manipulation; Diffusion Policy / Hierarchical Control
...
- Tags: Robot Manipulation; Diffusion Policy / Hierarchical Control
...
- **Key Idea:** 以 `Robot Manipulation; Diffusion Policy / Hierarchical Control` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://openaccess.thecvf.com/content/CVPR2024/html/Ma_Hierarchical_Diffusion_Policy_for_Kinematics-Aware_Multi-Task_Robotic_Manipulation_CVPR_2024_paper.html；官方摘要/论文集元数据
...
Abstract reports simulation and real-world evaluation.
...
### Model / Method
以 `Robot Manipulation; Diffusion Policy / Hierarchical Control` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
