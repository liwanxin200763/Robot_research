...
- Keywords: Robot Manipulation; Diffusion Policy / Primitive Skills
...
- Tags: Robot Manipulation; Diffusion Policy / Primitive Skills

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/38889
- DOI: Unknown
- arXiv: 
- Project Page: 
...
- **Main Contribution:**
  ...
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- **Key Idea:** 以 `Robot Manipulation; Diffusion Policy / Primitive Skills` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/38889；官方摘要/论文集元数据
...
AAAI-26 intelligent robotics track; abstract reports simulation and real-world deployment.
...
### Model / Method
以 `Robot Manipulation; Diffusion Policy / Primitive Skills` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://ojs.aaai.org/index.php/AAAI/article/view/38889
