...
- Authors: Jia, Xiaogang; Wang, Qian; Wang, Anrui; Wang, Han; Gyenes, Balázs; Gospodinov, Emiliyan; Jiang, Xinkai; Li, Ge; Zhou, Hongyi; Liao, Weiran; Huang, Xi; Beck, Maximilian; Reuss, Moritz; Lioutikov, Rudolf; Neumann, Gerhard
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: 3D Manipulation / Multimodal Policy
- Keywords: 3D Manipulation / Multimodal Policy

## Classification

- Primary Category: Diffusion / Flow / IL / RL
- Categories: Robot Manipulation; Diffusion / Flow / IL / RL
- Subcategories: 3D Manipulation / Multimodal Policy
- Tags: 3D Manipulation / Multimodal Policy

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/eacc8ae341d15d2c13c02fef88189db3-Abstract-Conference.html
...
- **Problem:** 研究主题为 `3D Manipulation / Multimodal Policy`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - We introduce PointMapPolicy, a novel approach that conditions diffusion policies on structured grids of points without downsampling.
  - Through extensive experiments on the RoboCasa and CALVIN benchmarks and real robot evaluations, we demonstrate that our method achieves state-of-the-art performance across diverse manipulation tasks.
- **Key Idea:** 以 `3D Manipulation / Multimodal Policy` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/eacc8ae341d15d2c13c02fef88189db3-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4417082659
- OpenAlex Work: https://openalex.org/W4417082659

## Standardized Research Fields

### Research Problem
研究主题为 `3D Manipulation / Multimodal Policy`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `3D Manipulation / Multimodal Policy` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/eacc8ae341d15d2c13c02fef88189db3-Abstract-Conference.html
