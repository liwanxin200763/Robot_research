...
- Authors: Fu, Yuwei; Zhang, Haichao; Wu, Di; Xu, Wei; Boulet, Benoit
- Year: 2024
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Video Demonstration / Reward Learning
- Keywords: Video Demonstration / Reward Learning

## Classification

- Primary Category: Diffusion / Flow / IL / RL
- Categories: Robot Manipulation; Diffusion / Flow / IL / RL
- Subcategories: Video Demonstration / Reward Learning
- Tags: Video Demonstration / Reward Learning

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2024/hash/dcd297696d0bb304ba426b3c5a679c37-Abstract-Conference.html
...
- **Problem:** 研究主题为 `Video Demonstration / Reward Learning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- **Key Idea:** 以 `Video Demonstration / Reward Learning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2024/hash/dcd297696d0bb304ba426b3c5a679c37-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4415795570
- OpenAlex Work: https://openalex.org/W4415795570

## Standardized Research Fields

### Research Problem
研究主题为 `Video Demonstration / Reward Learning`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Video Demonstration / Reward Learning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2024/hash/dcd297696d0bb304ba426b3c5a679c37-Abstract-Conference.html; https://github.com/fuyw/TemporalOT
