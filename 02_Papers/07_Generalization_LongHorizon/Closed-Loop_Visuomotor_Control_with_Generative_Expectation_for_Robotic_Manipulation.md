...
- Authors: Bu, Qingwen; Zeng, Jia; Chen, Li; Yang, Yanchao; Zhou, Guyue; Yan, Junchi; Luo, Ping; Cui, Heming; Ma, Yi; Li, Hongyang
- Year: 2024
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Long-Horizon / Failure Recovery
- Keywords: Long-Horizon / Failure Recovery

## Classification

- Primary Category: Generalization / Long-Horizon
- Categories: Robot Manipulation; Generalization / Long-Horizon
- Subcategories: Long-Horizon / Failure Recovery
- Tags: Long-Horizon / Failure Recovery

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2024/hash/fad8962279154544ed69bb63eb14d677-Abstract-Conference.html
...
- **Problem:** 研究主题为 `Long-Horizon / Failure Recovery`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - Inspired by classic closed-loop control systems, we propose CLOVER, a closed-loop visuomotor control framework that incorporates feedback mechanisms to improve adaptive robotic control.
  - Despite significant progress in robotics and embodied AI in recent years, deploying robots for long-horizon tasks remains a great challenge.
- **Key Idea:** 以 `Long-Horizon / Failure Recovery` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2024/hash/fad8962279154544ed69bb63eb14d677-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4415800541
- OpenAlex Work: https://openalex.org/W4415800541

## Standardized Research Fields

### Research Problem
研究主题为 `Long-Horizon / Failure Recovery`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Long-Horizon / Failure Recovery` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2024/hash/fad8962279154544ed69bb63eb14d677-Abstract-Conference.html; https://github.com/OpenDriveLab/CLOVER
