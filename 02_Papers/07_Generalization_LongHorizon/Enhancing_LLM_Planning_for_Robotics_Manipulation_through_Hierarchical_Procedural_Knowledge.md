...
- Authors: Zhou, Jiacong; Miao, Jiaxu; wang, xianyun; Yu, Jun
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Long-Horizon / Planning
...
- Subcategories: Long-Horizon / Planning
- Tags: Long-Horizon / Planning

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/b94310e1c7ecb79f1a24adc757f1b89b-Abstract-Conference.html
...
- **Problem:** 研究主题为 `Long-Horizon / Planning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  ...
  - Extensive experiments demonstrate that small scale LLMs (7B) enhanced by our HP-KG significantly improve the planning capabilities, which are stronger than 72B LLMs only.
- **Key Idea:** 以 `Long-Horizon / Planning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/b94310e1c7ecb79f1a24adc757f1b89b-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W7196926233
- OpenAlex Work: https://openalex.org/W7196926233

## Standardized Research Fields

### Research Problem
研究主题为 `Long-Horizon / Planning`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Long-Horizon / Planning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/b94310e1c7ecb79f1a24adc757f1b89b-Abstract-Conference.html
