...
- Subcategory: Articulated Object / Affordance
- Keywords: Articulated Object / Affordance

## Classification

- Primary Category: Generalization / Long-Horizon
- Categories: Robot Manipulation; Generalization / Long-Horizon
- Subcategories: Articulated Object / Affordance
- Tags: Articulated Object / Affordance

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/33615
- DOI: Unknown
- arXiv: Unknown
...
- **Problem:** 研究主题为 `Articulated Object / Affordance`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- **Key Idea:** 以 `Articulated Object / Affordance` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/33615；官方摘要/论文集元数据
...
### Research Problem
研究主题为 `Articulated Object / Affordance`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Articulated Object / Affordance` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
