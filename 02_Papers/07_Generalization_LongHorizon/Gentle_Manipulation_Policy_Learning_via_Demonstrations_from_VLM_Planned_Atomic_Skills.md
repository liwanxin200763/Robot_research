...
- Keywords: Robot Manipulation; Long-Horizon / Visual-Tactile Policy
...
- Tags: Robot Manipulation; Long-Horizon / Visual-Tactile Policy

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/38955
- DOI: Unknown
- arXiv: 
- Project Page: 
...
- **Main Contribution:**
  ...
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- **Key Idea:** 以 `Robot Manipulation; Long-Horizon / Visual-Tactile Policy` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/38955；官方摘要/论文集元数据
...
Abstract reports simulation learning and physical deployment.
...
### Model / Method
以 `Robot Manipulation; Long-Horizon / Visual-Tactile Policy` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://ojs.aaai.org/index.php/AAAI/article/view/38955
