...
- Subcategory: Long-Horizon / Mobile Manipulation
- Keywords: Long-Horizon / Mobile Manipulation

## Classification

- Primary Category: Generalization / Long-Horizon
- Categories: Robot Manipulation; Generalization / Long-Horizon
- Subcategories: Long-Horizon / Mobile Manipulation
- Tags: Long-Horizon / Mobile Manipulation
...
- Embodiment: Humanoid / Mobile Manipulator
...
- **Problem:** 研究主题为 `Long-Horizon / Mobile Manipulation`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- **Key Idea:** 以 `Long-Horizon / Mobile Manipulation` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/33610；官方摘要/论文集元数据
...
### Research Problem
研究主题为 `Long-Horizon / Mobile Manipulation`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Long-Horizon / Mobile Manipulation` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://ojs.aaai.org/index.php/AAAI/article/view/33610
...
- Problem: Long-horizon embodied planning can fail when language plans are not grounded in current environment state.
...
- Summary Evidence: Official abstract / paper page; https://ojs.aaai.org/index.php/AAAI/article/view/33610; checked 2026-09-23. Rapid summary only; existing Evidence Quality is unchanged.
