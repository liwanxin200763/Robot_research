...
- Authors: Chen, Junting; Liang, Haotian; Du, Lingxiao; Wang, Weiyun; Hu, Mengkang; Mu, Yao; Wang, Wenhai; Dai, Jifeng; Luo, Ping; Shao, Wenqi; Shao, Lin
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Mobile Manipulation / Agent
- Keywords: Mobile Manipulation / Agent

## Classification

- Primary Category: Generalization / Long-Horizon
- Categories: VLA; Robot Manipulation; Generalization / Long-Horizon
- Subcategories: Mobile Manipulation / Agent
- Tags: Mobile Manipulation / Agent

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/bc97207e3979d1cc23109db0be0e8ed2-Abstract-Conference.html
...
- **Problem:** 研究主题为 `Mobile Manipulation / Agent`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- **Key Idea:** 以 `Mobile Manipulation / Agent` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/bc97207e3979d1cc23109db0be0e8ed2-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W7197036842
- OpenAlex Work: https://openalex.org/W7197036842

## Standardized Research Fields

### Research Problem
研究主题为 `Mobile Manipulation / Agent`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Mobile Manipulation / Agent` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/bc97207e3979d1cc23109db0be0e8ed2-Abstract-Conference.html
