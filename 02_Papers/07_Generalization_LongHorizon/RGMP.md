...
- Keywords: Robot Manipulation; Humanoid / Generalization
...
- Tags: Robot Manipulation; Humanoid / Generalization

## Paper Links（论文）

- Official Paper: https://ojs.aaai.org/index.php/AAAI/article/view/38539
- DOI: Unknown
- arXiv: 
- Project Page: 
...
- **Main Contribution:**
  ...
  - 官方题名与元数据已确认；具体表述待补读官方摘要或正文。
- **Key Idea:** 以 `Robot Manipulation; Humanoid / Generalization` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://ojs.aaai.org/index.php/AAAI/article/view/38539；官方摘要/论文集元数据
...
Abstract reports humanoid and tabletop robot experiments.
...
### Model / Method
以 `Robot Manipulation; Humanoid / Generalization` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://ojs.aaai.org/index.php/AAAI/article/view/38539
...
官方摘要/论文页：https://ojs.aaai.org/index.php/AAAI/article/view/38539；核验于 2026-09-23。仅为摘要级速读，原 Evidence Quality 不变。
