...
- Authors: Ye, Haoming; Xiao, Yunxiao; Lu, Cewu; Cai, Panpan
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Task Planning / Demonstrations
- Keywords: Task Planning / Demonstrations

## Classification

- Primary Category: Generalization / Long-Horizon
- Categories: Robot Manipulation; Generalization / Long-Horizon
- Subcategories: Task Planning / Demonstrations
- Tags: Task Planning / Demonstrations

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/b8358a00e5b870194b974ddf8dd415c3-Abstract-Conference.html
...
- **Problem:** 研究主题为 `Task Planning / Demonstrations`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- **Key Idea:** 以 `Task Planning / Demonstrations` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/b8358a00e5b870194b974ddf8dd415c3-Abstract-Conference.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W7196933803
- OpenAlex Work: https://openalex.org/W7196933803

## Standardized Research Fields

### Research Problem
研究主题为 `Task Planning / Demonstrations`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Task Planning / Demonstrations` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/b8358a00e5b870194b974ddf8dd415c3-Abstract-Conference.html
