...
- Subcategory: Synthetic Data / Scene Generation
- Keywords: Synthetic Data / Scene Generation

## Classification

- Primary Category: Data / Teleoperation
- Categories: Robot Manipulation; Data / Teleoperation
- Subcategories: Synthetic Data / Scene Generation
- Tags: Synthetic Data / Scene Generation

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/CVPR2025/html/Lee_DynScene_Scalable_Generation_of_Dynamic_Robotic_Manipulation_Scenes_for_Embodied_CVPR_2025_paper.html
- DOI: Unknown
- arXiv: Unknown
...
- **Problem:** 研究主题为 `Synthetic Data / Scene Generation`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - We present DynScene, a diffusion-based framework for generating dynamic robotic manipulation scenes directly from textual instructions.
  - Experiments show DynScene achieves 26.8x faster generation, 1.84x higher accuracy, and 28% greater action diversity than human-crafted data.
- **Key Idea:** 以 `Synthetic Data / Scene Generation` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://openaccess.thecvf.com/content/CVPR2025/html/Lee_DynScene_Scalable_Generation_of_Dynamic_Robotic_Manipulation_Scenes_for_Embodied_CVPR_2025_paper.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W4413147695
- OpenAlex Work: https://openalex.org/W4413147695

## Standardized Research Fields

### Research Problem
研究主题为 `Synthetic Data / Scene Generation`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Synthetic Data / Scene Generation` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
