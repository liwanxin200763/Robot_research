...
- Authors: Chen, Kaiyuan Eric; Xie, Shuangyu; Ma, Zehan; Sanketi, Pannag ; Goldberg, Ken
- Year: 2025
- Venue: NeurIPS
- CCF Level: A
...
- Subcategory: Robot Data / Spatial Reasoning
- Keywords: Robot Data / Spatial Reasoning

## Classification

- Primary Category: Data / Teleoperation
- Categories: Robot Manipulation; Data / Teleoperation; Benchmark / Dataset
- Subcategories: Robot Data / Spatial Reasoning
- Tags: Robot Data / Spatial Reasoning

## Paper Links（论文）

- Official Paper: https://proceedings.neurips.cc/paper_files/paper/2025/hash/1f467c3e37abf9f86c78f44c6a27ee7c-Abstract-Datasets_and_Benchmarks_Track.html
...
- **Problem:** 研究主题为 `Robot Data / Spatial Reasoning`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
  - In this paper, we present Robo2VLM, a Visual Question Answering (VQA) dataset generation framework for VLMs.
  - Results suggest that Robo2VLM-1 can benchmark and improve VLM capabilities in spatial and interaction reasoning.
- **Key Idea:** 以 `Robot Data / Spatial Reasoning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
- Sources: https://proceedings.neurips.cc/paper_files/paper/2025/hash/1f467c3e37abf9f86c78f44c6a27ee7c-Abstract-Datasets_and_Benchmarks_Track.html；官方摘要/论文集元数据
...
- Citation Source Identifier: https://openalex.org/W7196982428
- OpenAlex Work: https://openalex.org/W7196982428

## Standardized Research Fields

### Research Problem
研究主题为 `Robot Data / Spatial Reasoning`；本卡仅按官方摘要级证据整理，未替代全文审阅。

### What Previous Problem Does This Paper Solve?
Unknown / Needs Full-Paper Verification

### Model / Method
以 `Robot Data / Spatial Reasoning` 为主要方法/能力线索；更细的结构和消融结论待正文核验。
...
### Evidence Sources
https://proceedings.neurips.cc/paper_files/paper/2025/hash/1f467c3e37abf9f86c78f44c6a27ee7c-Abstract-Datasets_and_Benchmarks_Track.html
...
- [[02_Papers/09_Survey_Review/Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey|Towards_a_Unified_Understanding_of_Robot_Manipulation_A_Comprehensive_Survey]] — [arXiv full-text bibliography item 179](https://arxiv.org/html/2510.10903#bib.bib179)
