...
核心思路是整理 object-centric embodied learning 的方法和操作任务分类。
与当前项目的联系：Medium：物体中心表示可用于普通夹爪协作。

## 核心关键词

Survey、Review、Imitation Learning、Diffusion、Flow Matching、Robot Manipulation、IL
