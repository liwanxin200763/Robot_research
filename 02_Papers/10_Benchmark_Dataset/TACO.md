...
- Subcategory: Tool-Action-Object Understanding
- Keywords: Unknown

## Classification

- Primary Category: Benchmark / Dataset
- Categories: Robot Manipulation; Bimanual; Generalization / Long-Horizon; Data / Teleoperation; Benchmark / Dataset
- Subcategories: Tool-Action-Object Understanding
- Tags: Unknown

## Paper Links（论文）

- Official Paper: https://openaccess.thecvf.com/content/CVPR2024/papers/Liu_TACO_Benchmarking_Generalizable_Bimanual_Tool-ACtion-Object_Understanding_CVPR_2024_paper.pdf
- DOI: Unknown
- arXiv: Unknown
...
- Embodiment: Bimanual Human Interaction
...
- **Problem:** 研究主题为 `Tool-Action-Object Understanding`；本卡仅按官方摘要级证据整理，未替代全文审阅。
- **Main Contribution:**
...
- Sources: https://openaccess.thecvf.com/content/CVPR2024/papers/Liu_TACO_Benchmarking_Generalizable_Bimanual_Tool-ACtion-Object_Understanding_CVPR_2024_paper.pdf；官方摘要/论文集元数据
...
### Research Problem
研究主题为 `Tool-Action-Object Understanding`；本卡仅按官方摘要级证据整理，未替代全文审阅。
...
双手工具—动作—物体理解缺少足够多样且标注完整的数据。

### 之前方法的问题

已有手—物交互数据多集中在单手、单物体场景。

### 核心思路

TACO 提供约 2500 条双手交互序列、第三人称与第一人称视角、三维网格和动作标签。
...
TACO：约 2500 条序列及三个基准任务。

### 主要结果

CVPR 官方论文评测组合动作识别、手—物运动预测与协同抓取生成；摘要未给统一成功率。

### 为什么重要

可用于理解双手协同与工具功能，但人手动作迁移到普通夹爪需验证。
...
官方摘要/论文页：https://openaccess.thecvf.com/content/CVPR2024/papers/Liu_TACO_Benchmarking_Generalizable_Bimanual_Tool-ACtion-Object_Understanding_CVPR_2024_paper.pdf；核验于 2026-09-23。仅为摘要级速读，原 Evidence Quality 不变。
